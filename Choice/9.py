...
print (Colorate.Diagonal(Colors.rainbow, "║  Tool Get Cookie Bằng Tk Mk Facebook          ║"))
print (Colorate.Diagonal(Colors.rainbow, "╚══════════════════════════════╝"))

user = input('\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Tài Khoản : \033[1;36m')
password = input('\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Mật Khẩu : \033[1;36m')
...
try:
    code = requests.get('https://taokey567.TVHtool.net/src/2fa.php?2fa={_2FA}').json()['code']
    ...
    ten = TVH.CheckCookie(cookie, userid)
