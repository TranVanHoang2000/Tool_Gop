...
print(f'\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Số \033[1;32m[\033[1;31m9\033[1;32m]\033[1;36m Tool Get Cookie Facebook Bằng TK MK')
...
print (Colorate.Diagonal(Colors.rainbow, "╚════════════════╝"))
print(f'\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Số \033[1;32m[\033[1;31m11\033[1;32m]\033[1;36m Tool Doss Web + Doss IP')
...
print(f'\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Số \033[1;32m[\033[1;31m16\033[1;32m]\033[1;36m Tool Buff Tiktok [PC]')
print(f'\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Số \033[1;32m[\033[1;31m17\033[1;32m]\033[1;36m Tool Buff Tiktok [ADR, IPA]')
print(f'\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Số \033[1;32m[\033[1;31m18\033[1;32m]\033[1;36m Tool Reg Nick FB')
print (Colorate.Diagonal(Colors.blue_to_green, "══════════════════════════════════════════════════════════════"))

chon = str(input("\033[1;32m[\033[1;31m♤\033[1;32m] \033[1;33m➩ \033[1;32mNhập Số \033[1;31m: \033[1;36m"))

if chon == '1' :
    exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Tool_Gop/refs/heads/main/Choice/1.py').text)
if chon == '2':
    exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Tool_Gop/refs/heads/main/Choice/2.py').text)
if chon == '3' :
    exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Tool_Gop/refs/heads/main/Choice/3.py').text) 
if chon == '4' :
    exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Tool_Gop/refs/heads/main/Choice/4.py').text) 
if chon == '5' : 
   exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Tool_Gop/refs/heads/main/Choice/5.py').text) 
if chon == '6' :
    exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Tool_Gop/refs/heads/main/Choice/6.py').text)
if chon == '7' :
   exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Tool_Gop/refs/heads/main/Choice/7.py').text)
if chon == '8' :
   exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Tool_Gop/refs/heads/main/Choice/8.py').text)
if chon == '9' :
    exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Tool_Gop/refs/heads/main/Choice/9.py').text)
if chon == '10' :
    exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Tool_Gop/refs/heads/main/Choice/10.py').text)
if chon == '11' :
    exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Tool_Gop/refs/heads/main/Choice/11.py').text)
if chon == '12' :
    exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Tool_Gop/refs/heads/main/Choice/12.py').text)
if chon == '13' :
    exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Tool_Gop/refs/heads/main/Choice/13.py').text)
if chon == '14' :
    exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Tool_Gop/refs/heads/main/Choice/14.py').text)
if chon == '15' :
    exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Tool_Gop/refs/heads/main/Choice/15.py').text)
if chon == '16' :
    exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Tool_Gop/refs/heads/main/Choice/16.py').text)
if chon == '17' :
